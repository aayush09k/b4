      ...
      ''';
        ...
        if (_cache.containsKey(indexData['keyword'])) {
          _cache[indexData['keyword']] = {
            ...
            'lastUpdateTime': dateToString(getDateTime()),
            'expirationDate': dateToString(expirationDate),
            'timestamp': getDateTime().millisecondsSinceEpoch, //Add a timestamp
          };
