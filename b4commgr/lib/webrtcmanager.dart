...
//declaration of variables
  ...
  Future<void> PeerConnection(configuration) async {
    ...
    print('server start');
    localStream =
    await getusermedia(); // to get the local video and audio data. its necessary for getting ice candidates.
    RTCPeerConnection pc = await createPeerConnection(
        configuration, offerSdpConstraints); //instance of peerconnection.
...
return  jsonEncode(session);
  ...
  Future<void> setRemoteDescription(String jsonString) async {
    ...
    RTCSessionDescription description = RTCSessionDescription(
        sdp, offer ? 'answer' : 'offer'); //constructor call
